...
class User(AbstractUser):
    ...
    class Department(models.TextChoices):
        ...
        PRODUCTION_ENGINEERING_ALUMINIUM_3 = 'production_engineering_aluminium_3', 'Production Engineering Aluminium #3'
        ...
        PRODUCTION_ENGINEERING_STEEL_3 = 'production_engineering_steel_3', 'Production Engineering Steel #3'
