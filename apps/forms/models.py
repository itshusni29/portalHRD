...
class Training(models.Model):
    ...
    participants = models.TextField(max_length=2500)
    ...
    pic_trainings = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='pic_trainings', null=True)
